...
// SysCronDao is the data access object for the table gf_sys_cron.
...
// SysCronColumns defines and stores column names for the table gf_sys_cron.
...
// sysCronColumns holds the columns for the table gf_sys_cron.
