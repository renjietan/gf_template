...
// FamliyDao is the data access object for the table famliy.
...
// FamliyColumns defines and stores column names for the table famliy.
type FamliyColumns struct {
	Id   string //
	Name string //
}

// famliyColumns holds the columns for the table famliy.
