...
// SysCronGroupDao is the data access object for the table gf_sys_cron_group.
...
// SysCronGroupColumns defines and stores column names for the table gf_sys_cron_group.
...
// sysCronGroupColumns holds the columns for the table gf_sys_cron_group.
